...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*ConstantScoreArgs)(nil), (*config.ConstantScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ConstantScoreArgs_To_config_ConstantScoreArgs(a.(*ConstantScoreArgs), b.(*config.ConstantScoreArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ConstantScoreArgs)(nil), (*ConstantScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ConstantScoreArgs_To_v1_ConstantScoreArgs(a.(*config.ConstantScoreArgs), b.(*ConstantScoreArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ConstantScoreArgs_To_config_ConstantScoreArgs(in *ConstantScoreArgs, out *config.ConstantScoreArgs, s conversion.Scope) error {
...
// Convert_v1_ConstantScoreArgs_To_config_ConstantScoreArgs is an autogenerated conversion function.
func Convert_v1_ConstantScoreArgs_To_config_ConstantScoreArgs(in *ConstantScoreArgs, out *config.ConstantScoreArgs, s conversion.Scope) error {
	return autoConvert_v1_ConstantScoreArgs_To_config_ConstantScoreArgs(in, out, s)
}

func autoConvert_config_ConstantScoreArgs_To_v1_ConstantScoreArgs(in *config.ConstantScoreArgs, out *ConstantScoreArgs, s conversion.Scope) error {
...
// Convert_config_ConstantScoreArgs_To_v1_ConstantScoreArgs is an autogenerated conversion function.
func Convert_config_ConstantScoreArgs_To_v1_ConstantScoreArgs(in *config.ConstantScoreArgs, out *ConstantScoreArgs, s conversion.Scope) error {
	return autoConvert_config_ConstantScoreArgs_To_v1_ConstantScoreArgs(in, out, s)
}
...
func autoConvert_v1_HyperAIArgs_To_config_HyperAIArgs(in *HyperAIArgs, out *config.HyperAIArgs, s conversion.Scope) error {
	out.GRPCAddress = in.GRPCAddress
	out.Score = in.Score
	return nil
}
